        ...
        if (res.ok) {
          ...
          if (res.status === 404) {
            ...
            toast({
              variant: 'destructive',
              title: 'Uh oh! Something went wrong.',
              description: 'There was a problem deleting the streamer.',
            });
          }
        }
      }
        ...
        <Dialog>
          <DropdownMenu>
            ...
            <DropdownMenuContent align='end'>
              ...
              <DropdownMenuItem>Update Streamer</DropdownMenuItem>
              <DialogTrigger asChild>
                <DropdownMenuItem>Delete Streamer</DropdownMenuItem>
              </DialogTrigger>
